...
try {
  ...
  const storedVersion = parseInt(localStorage.getItem("keto_seed_v2") || "0");
  ...
  if (storedVersion < SEED_VERSION) {
    ...
    localStorage.setItem("keto_seed_v2", String(SEED_VERSION));
