  ...
  if (showHelp) return (
    <div style={{ minHeight: "100vh", background: "#111", color: "#f0ede8", fontFamily: "system-ui, sans-serif", maxWidth: 420, margin: "0 auto", paddingBottom: 40 }}>
      ...
      <div style={{ padding: "16px 16px 0" }}>
        {[
          { title: "Getting Started", icon: "🚀", content: "Set up your profile first — tap Edit in the top right. Enter your weight, height, age, activity level and goal. The app calculates your daily calorie and macro targets automatically. Each morning, log the previous day calories burned from your fitness device (Garmin, Apple Watch, etc.). This gives you your deficit — the difference between what you burned and what you ate." },
          { title: "Logging Food", icon: "🍽", content: "Use the Add tab to log food. The Foods tab has preset foods and your saved My Foods list. The AI tab lets you describe a meal in plain language and get nutritional values back. Quick Log lets you describe your entire day at once. Tap any logged food to expand and see full nutritional detail including minerals." },
          ...
          { title: "Minerals", icon: "⚗️", content: "The four key minerals tracked here interact with each other and are commonly depleted on low-carb diets. Sodium and potassium regulate fluid balance and blood pressure. Magnesium supports over 300 enzymatic reactions including sleep and muscle function. Calcium is critical for bone density. Use the +/- controls next to each mineral to log supplement doses." },
          { title: "Magnesium", icon: "💜", content: "The magnesium target is based on the NIH RDA: 420mg/day for men and 320mg/day for women aged 31+. Low-carb and Mediterranean diets can deplete magnesium faster. The upper safe limit for supplements is 350mg/day — from food there is no upper limit. Adjust your supplement dose based on how much you got from food today." },
          { title: "Glucose and Ketone Readings", icon: "🩸", content: "Log glucose and ketone readings to track your metabolic health directly. Best times: fasting glucose first thing in the morning, post-meal glucose 1-2 hours after eating, ketones in the afternoon or before bed. Target ranges: fasting glucose 4.0-5.5 mmol/L, post-meal under 7.8 mmol/L, nutritional ketosis 0.5-3.0 mmol/L." },
